...
namespace Slin.Masking
{
    ...
    public class ObjectMasker : IObjectMasker
    {
        ...
        /// <summary>
        /// constructor with <see cref="IMaskingOptions"/>. Default <see cref="IMasker"/> of <see cref="Masker"/>, <see cref="IJsonMasker"/> and <see cref="IXmlMasker"/> will be built base on it.
        /// </summary>
        /// <param name="options"></param>
        public ObjectMasker(IMaskingProfile options) : this(new Masker(options), options)
        {
        }

        /// <summary>
        /// constructor with given <see cref="IMasker"/> instance and <see cref="IObjectMaskingOptions"/>.
        /// </summary>
        /// <param name="masker"></param>
        /// <param name="options"></param>
